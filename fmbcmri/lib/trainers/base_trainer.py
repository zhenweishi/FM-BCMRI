...
from fmbcmri.lib.datasets import ImageListDataset
from fmbcmri.lib.transforms import MultiTransforms, GaussianBlur
...
class BaseTrainer(object):
    ...
    def build_model(self):
        if self.model_name != 'Unknown' and self.model is None:
            ...
            self.model = getattr(models, self.model_name)(args)
            self.wrap_model()
